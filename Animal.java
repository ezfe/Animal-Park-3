...
public class Animal extends Organism {
    ...
    public boolean randomMove() {
        ...
        for (int i = 0; i < NEIGHBOR_DIRECTIONS.size(); i += 1) {
            ...
            if (this.getCell() != null && this.getCell().getNeighbor(direction) != null && !this.getCell().getNeighbor(direction).hasAnimal() && !this.getCell().getNeighbor(direction).isMountain()) {
